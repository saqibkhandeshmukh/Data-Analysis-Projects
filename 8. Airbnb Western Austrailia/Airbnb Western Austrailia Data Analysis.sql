--- create database ---
	create database "airbnb western austrailia data analysis"
...
--- import data into listings ---
	...
	from 'D:\SKD\Data Analyst\3. SQL\3. Project\9. Airbnb Western Austrailia\listings.csv'
	delimiter ','
	csv header
...
--- Queries ---
	...
	-- the temporary table contains the percentage of distinct hosts listings)
	create temporary table distinct_host as
	select
		distinct host_id,
		host_name,
		calculated_host_listings_count as total_listings,
	...
	-- filtering total_listings > 1
	select *
	from distinct_host
	--where total_listings > 1

	-- percentage of hosts who have more than one listing
	select
